...
For the web service:
	- Pour build et run le projet : 
		...
		- Effectuer cette suite de commandes :
			...
			- URL pour appeler le service de la création de zone et de terrain: http://localhost:8080/GeoCatchingWebService//Partie/AddTerrain/(partie, coordonnee, type) (type = "0" pour terrain et autre pour zone , chaque coordonnées séparées par un -)
