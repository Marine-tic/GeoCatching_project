...
For the web service:
	- Pour build et run le projet : 
		...
		- Effectuer cette suite de commandes :
			...
			- URL pour appeler le service de la création d'une partie: http://localhost:8080/GeoCatchingWebService/Partie/AddPartie/(name, dateFin) (Date sous la forme jj/mm/aaaa exemple pour le 2 juin 2017 2/06/2017)
