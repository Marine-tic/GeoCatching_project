...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, NoticeDialogFragment.NoticeDialogListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDrawerList.setOnItemClickListener(new MapsActivity.DrawerItemClickListener());
        ...
        mMap.setOnPolygonClickListener(new GoogleMap.OnPolygonClickListener() {
            ...
            public void onPolygonClick(Polygon polygon) {
                ...
                if(polygon.getStrokeColor() == Color.BLUE && polygon.getFillColor() == Color.argb(100, 0, 0, 255)) {
                    ...
                    showNoticeDialog("Vous avez capturer la zone");
                }
            }
        });
